...
public class FieldController {
	...
	public ResponseEntity<?> editField(@RequestBody FieldDTO request){
		fieldService.editField(request);
		return new ResponseEntity<>(HttpStatus.OK);
	}
	
	@PutMapping("setFieldCoordinates")
	public ResponseEntity<?> setFieldCoordinates(@RequestBody FieldPolygonDTO data){
		fieldService.setFieldCoordinates(data);
		return new ResponseEntity<>(HttpStatus.OK);
	}
}
