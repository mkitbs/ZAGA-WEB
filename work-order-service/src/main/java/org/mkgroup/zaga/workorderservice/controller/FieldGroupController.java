...
public class FieldGroupController {
	...
	@PostMapping("editFieldGroup")
	public ResponseEntity<?> editFieldGroup(@RequestBody FieldGroupEditDTO fieldGroupDTO){
		fieldGroupService.editFieldGroup(fieldGroupDTO);
